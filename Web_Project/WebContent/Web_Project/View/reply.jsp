...
<%
	...
	//제목을 넘겨받음
	String title = dao.Reply_posts(num);

%>
<div style ="padding:50px">
<h4> 게시글 작성</h4>
<form action="../logic/reply_Check.jsp" name="posts" method="post" class="form-horizontal" onsubmit="return form_check()">
...
<table class="table table-striped table-bordered">
	...
	<tr>
		<th >제목</th>                                     <!-- 제목 입력 -->
		<td><input type="text" class="form-control" name="title" value="[답변]<%= title %>" readonly></td>
	</tr>
	<tr>
		<th >내용</th>                                     <!-- 내용 입력 -->
